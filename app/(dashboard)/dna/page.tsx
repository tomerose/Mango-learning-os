...
export default function DnaPage() {
  ...
  return (
    <PageShell title="Mango DNA" description="Personality profiles and voice soul distillation">
      <Tabs value={tab} onValueChange={setTab}>
        <TabsList>
          <TabsTrigger value="dna"><Dna className="size-4 mr-1.5" />数字身份</TabsTrigger>
