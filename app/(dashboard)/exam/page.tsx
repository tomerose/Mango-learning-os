...
import { Network, FileText, BookMarked, Trees } from "lucide-react";
...
export default function ExamPage() {
  const [tab, setTab] = React.useState("forest");

  return (<PageTransition>
    <div className="relative">
      <ExamBackground />
      <PageShell title="Mangoing" description="你的知识操作系统 — 捕捉 · 连接 · 组织 · 生长">
