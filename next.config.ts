...
const nextConfig: NextConfig = {
  ...
  async redirects() {
    return [
      ...
      { source: "/exam-mode", destination: "/exam", permanent: true },
      { source: "/exam-mode/:path*", destination: "/exam", permanent: true },
      { source: "/exam-master", destination: "/exam", permanent: true },
      { source: "/exam-master/:path*", destination: "/exam", permanent: true },
